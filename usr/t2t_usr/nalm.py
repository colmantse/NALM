...
"""NALM, NALM-pos and adapted benchmark models from "Assessing 
Non-autoregressive Alignment in Neural Machine Translation via
Word Reordering"

The NALM and NALM-pos model is highly similar with the Transformer
model, with the exception of full attention in the decoder, this 
allows viterbi decoding during inference and yield good results in
different word ordering tasks.

See "Assessing Non-autoregressive Alignment in Neural Machine Translation 
via Word Reordering" for the full description of the model and the results 
obtained.
"""
